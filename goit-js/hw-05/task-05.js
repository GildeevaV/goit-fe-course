class Car {
   ...
   */
  constructor({ price = 0, maxSpeed, isOn = false, speed = 0, distance = 0 }) {
  ...
  static getSpecs(car) {
      console.log(car.maxSpeed, car.isOn, car.speed, car.distance, car.price);  
  }
  /*
...
// Car.colors = object {GREEN: 'GREEN', RED: 'RED'};
